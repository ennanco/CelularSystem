...
public class GradientDisabledDialog extends JDialog {

	private GradientEditor parent;
	private Point selected;
	
	public GradientDisabledDialog(GradientEditor parent, Point selected) {
		super(parent);
		this.parent = parent;
	...
	private void inicialice() {
        ...
        mainPanel.add(new JLabel("Disabled Gradient?"));
